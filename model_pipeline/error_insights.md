...
2. Long-durations deliveries are less common in the datset than short-ones. As such, the underprediction of deliveries will be a more common issue
...
4. Similarly, when the category is unknown (Traffic Condition/Weather), predictions are expected to be not as accurated due to their low amount of datapoints in the training set.
